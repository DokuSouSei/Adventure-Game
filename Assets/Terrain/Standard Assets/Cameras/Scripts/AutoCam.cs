...
namespace UnityStandardAssets.Cameras
{
    ...
    public class AutoCam : PivotBasedCameraRig
    {
        ...
        //private sceneload nextscenescript;
        ...
        void Update()
        {
            //if name of level is one with a player, find player and make it the target

            //if(SceneManager.GetActiveScene().name == "Level1" || SceneManager.GetActiveScene().name == "Level2") { m_Target = GameObject.FindGameObjectWithTag("player").transform; }
            //this enables clicking on objects and tries to load its tag as a level
